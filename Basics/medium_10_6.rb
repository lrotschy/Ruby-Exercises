...
#
# # ----------------
# # input: a string consisting of words that taken in order constitute a set of directions--a program
# # output: the result of calling the directions/methods
# #
# # create methods for each command
# # n Place a value n in the "register". Do not modify the stack.
...
# require 'pry-byebug'
#
# def push_method(stack,register)
#   stack.push(register)
# end
#
# # ADD Pops a value from the stack and adds it to the register value, storing the result in the register.
...
# # register = stack.pop
#
# def add_method(stack, register)
#   register = stack.pop + register
# end
#
# # SUB Pops a value from the stack and subtracts it from the register value, storing the result in the register.
# # input: stack, register
# # reigster = register - stack.pop
#
# def sub_method(stack, register)
...
# # register = stack.pop * register
#
# def mult_method(stack, register)
#   register *= stack.pop
# end
#
# # DIV Pops a value from the stack and divides it into the register value, storing the integer result in the register.
...
# # print register
#
# def print_method(register)
#   puts register
# end
#
# # All operations are integer operations (which is only important with DIV and MOD).
#
# # create minilang method
# #   create empty register and stack
# #
# #   string input
# #   convert to array of Words string.split
# #
# #   array.each do method
# #     call method on stack and register
# #   return register? register and stack? nothing specified
# def register_method(n, variable)
#   variable = n
# end
